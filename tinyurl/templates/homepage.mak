...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="//stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/css/bootstrap.min.css" rel="stylesheet"  integrity="sha384-r4NyP46KrjDleawBgD5tp8Y7UzmLA05oM1iAEQ17CSuDqnUK2+k9luXQOfXJCJ4I" crossorigin="anonymous">
    ...
    <body>
      ...
      <footer class="footer">
        <div class="container">
          <div class="text-center">
            <p class="text-muted">
              © 2015-2020 <a href="https://gitlab.com/offby1/">This guy right here</a>
              |
