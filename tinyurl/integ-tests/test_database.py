...
def test_get_one_days_hashes(ddb):
    rows = [
        {'human_hash': 'one'  , 'long_url': 'meh', 'create_day': '2017-01-12', 'create_date': '2017-01-12T12:00:00Z'},
        {'human_hash': 'two'  , 'long_url': 'meh', 'create_day': '2017-01-11', 'create_date': '2017-01-11T18:00:00Z'},
        {'human_hash': 'three', 'long_url': 'meh', 'create_day': '2017-01-11', 'create_date': '2017-01-11T06:00:00Z'},
    ...
    assert ddb.get_one_days_hashes(datetime.date(year=2017, month=1, day=11),
                                   later_than=datetime.datetime(year=2017, month=1, day=11, hour=6)) == rows[1:3]
